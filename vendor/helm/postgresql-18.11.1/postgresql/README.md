...
| `primary.networkPolicy.addExternalClientAccess`             | Allow access from pods with client label set to "true". Ignored if `primary.networkPolicy.allowExternal` is true.                                                                                                                 | `true`                |
...
| `primary.networkPolicy.ingressReleaseMatchLabels`           | Labels to match pods in the same release to allow traffic from. Ignored if `primary.networkPolicy.allowExternal` is true.                                                                                                         | `{}`                  |
...
| `readReplicas.networkPolicy.addExternalClientAccess`             | Allow access from pods with client label set to "true". Ignored if `readReplicas.networkPolicy.allowExternal` is true.                                                                                                                      | `true`                |
...
| `readReplicas.networkPolicy.ingressReleaseMatchLabels`           | Labels to match pods in the same release to allow traffic from. Ignored if `readReplicas.networkPolicy.allowExternal` is true.                                                                                                              | `{}`                  |
